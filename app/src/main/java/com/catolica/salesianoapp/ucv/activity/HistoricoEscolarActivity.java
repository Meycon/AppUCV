...
import com.catolica.salesianoapp.ucv.model.HistoricoEscolar;
import com.catolica.salesianoapp.ucv.model.Materia;
...
public class HistoricoEscolarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historico_escolar);

        //Vincula o Toolbar
        toolbar = (Toolbar) findViewById(R.id.toolbarHistoricoEscolar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Histórico Escolar");
        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerSlide(View drawerView, float slideOffset) {
                        KeyboardUtils.hideKeyboard(HistoricoEscolarActivity.this);
                    }
                })
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position) {
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                new AwesomeSuccessDialog(HistoricoEscolarActivity.this)
                                        .setTitle("Aviso")
        ...
        historicoList = new GsonBuilder().create().fromJson(loadJSONFromAsset(), listType);

        historicoAdapter = new HistoricoAdapter(historicoList, HistoricoEscolarActivity.this);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = getAssets().open("historico_manual.json");
    ...
    public void limpa() {
        int tamanho = this.historicoList.size();
        if (tamanho > 0) {
            for (int i = 0; i < tamanho; i++) {
                this.historicoList.remove(0);
            }
            historicoAdapter.notifyItemRangeRemoved(0, tamanho);
        }
    }
