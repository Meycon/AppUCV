...
public class NoticiasAdapter extends RecyclerView.Adapter<NoticiasAdapter.ViewHolder> {
    ...
    public NoticiasAdapter(Context context, List<Noticia> itens){
        this.itens = itens;
    ...
    @Override
    public NoticiasAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lista_itens_recentes,viewGroup,false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(NoticiasAdapter.ViewHolder holder, final int position) {
