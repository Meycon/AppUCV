...
import com.catolica.salesianoapp.ucv.fragment.TabFragmentDesempenho;
...
public class DesempenhoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Vincula o Toolbar
        toolbar = (Toolbar) findViewById(R.id.toolbarPrincipal_Desempenho);
        ...
        fragmentTransaction.replace(R.id.frameContainerPrincipal_Desempenho, new TabFragmentDesempenho()).commit();
        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerSlide(View drawerView, float slideOffset) {
                        KeyboardUtils.hideKeyboard(DesempenhoActivity.this);
                    }
                })
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position) {
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                new AwesomeSuccessDialog(DesempenhoActivity.this)
                                        .setTitle("Aviso")
