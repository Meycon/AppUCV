...
import com.catolica.salesianoapp.ucv.adapter.FinanceiroAdapter;
...
public class FinanceiroActivity extends AppCompatActivity {
    ...
    List<Financeiro> financeiroList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Vincula o Toolbar
        toolbar = (Toolbar) findViewById(R.id.toolbarFinanceiro);
        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerSlide(View drawerView, float slideOffset) {
                        KeyboardUtils.hideKeyboard(FinanceiroActivity.this);
                    }
                })
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position) {
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                new AwesomeSuccessDialog(FinanceiroActivity.this)
                                        .setTitle("Aviso")
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_financeiro);
        swipeRefreshLayout.setColorSchemeResources(R.color.red, R.color.red, R.color.red); //Color

        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewFinanceiro);
        recyclerView.setHasFixedSize(true);
        recyclerView.setVerticalScrollBarEnabled(true);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        financeiroList = new ArrayList<Financeiro>();

        // Verifica se esta conectado e da um GET JSON
        if (JsonUtils.estaConectado(this)) {
            new FinanceiroTask().execute(Config.URL_FINANCEIRO_GET);
        } else {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (JsonUtils.estaConectado(getApplicationContext())) {
                            ...
                            new AwesomeErrorDialog(FinanceiroActivity.this)
                                    .setTitle("Erro")
                                    .setMessage("Falha na conexão com a internet.")
                                    .setColoredCircle(R.color.dialogErrorBackgroundColor)
                                    .setDialogIconAndColor(R.drawable.ic_dialog_error, R.color.white)
    ...
    public void limpa() {
        int tamanho = this.financeiroList.size();
        if (tamanho > 0) {
            for (int i = 0; i < tamanho; i++) {
                this.financeiroList.remove(0);
            }
            financeiroAdapter.notifyItemRangeRemoved(0, tamanho);
        }
    }
    ...
    public class FinanceiroTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(FinanceiroActivity.this);
        ...
        protected void onPostExecute(String resultado) {
            ...
            if (null == resultado || resultado.length() == 0) {
                ...
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("Financeiro");
                    JSONObject objJson = null;
                    for (int i = 0; i < jsonArray.length(); i++) {
                        objJson = jsonArray.getJSONObject(i);

                        Financeiro financeiro = new Financeiro();
                        financeiro.setIdboleto(objJson.getString("idboleto"));
                        financeiro.setSemestre(objJson.getString("semestre"));
                        financeiro.setCodigo_barra(objJson.getString("codigo_barra"));
                        financeiro.setSituacao(objJson.getString("situacao"));
                        financeiro.setVencimento(objJson.getString("vencimento"));
                        financeiro.setValor_bruto(objJson.getString("valor_bruto"));

                        financeiroList.add(financeiro);
                    }
                    financeiroAdapter = new FinanceiroAdapter(financeiroList, FinanceiroActivity.this);
                    recyclerView.setAdapter(financeiroAdapter);
