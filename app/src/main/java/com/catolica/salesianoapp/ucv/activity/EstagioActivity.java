...
import com.catolica.salesianoapp.ucv.adapter.EstagioAdapter;
...
public class EstagioActivity extends AppCompatActivity {
    ...
    Toolbar toolbar;
    EstagioAdapter estagioAdapter;
    private AccountHeader headerResult = null;
    private Drawer result = null;
    private RecyclerView recyclerView;
    private ArrayList<Estagio> estagioList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Vincula o Toolbar
        toolbar = (Toolbar) findViewById(R.id.toolbarEstagio);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Estágios/Empregos");
        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerSlide(View drawerView, float slideOffset) {
                        KeyboardUtils.hideKeyboard(EstagioActivity.this);
                    }
                })
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position) {
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                new AwesomeSuccessDialog(EstagioActivity.this)
                                        .setTitle("Aviso")
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_Estagio);
        swipeRefreshLayout.setColorSchemeResources(R.color.red, R.color.red, R.color.red); //Color

        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewEstagio);
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        limpa();
                        Type listType = new TypeToken<ArrayList<Estagio>>() {
                        }.getType();
                        estagioList = new GsonBuilder().create().fromJson(loadJSONFromAsset(), listType);
                        estagioAdapter = new EstagioAdapter(estagioList, EstagioActivity.this);
                        recyclerView.setAdapter(estagioAdapter);
                    }
                }, 400);
            }
        });
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = getAssets().open("estagio.json");
    ...
    public void limpa() {
        int tamanho = this.estagioList.size();
        if (tamanho > 0) {
            for (int i = 0; i < tamanho; i++) {
                this.estagioList.remove(0);
            }
            estagioAdapter.notifyItemRangeRemoved(0, tamanho);
        }
    }
