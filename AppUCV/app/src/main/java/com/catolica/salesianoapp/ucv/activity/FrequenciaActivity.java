...
public class FrequenciaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Vincula o Toolbar
        toolbar = (Toolbar) findViewById(R.id.toolbarFrequencia);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Faltas no Semestre");
       ...
       //Bootstrap
        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerSlide(View drawerView, float slideOffset) {
                        KeyboardUtils.hideKeyboard(FrequenciaActivity.this);
                    }
                })
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position) {
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                new AwesomeSuccessDialog(FrequenciaActivity.this)
                                        .setTitle("Aviso")
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_frequencia);
        swipeRefreshLayout.setColorSchemeResources(R.color.red, R.color.red, R.color.red); //Color

        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewFrequencia);
        recyclerView.setHasFixedSize(true);
        recyclerView.setVerticalScrollBarEnabled(true);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        frequenciaList = new ArrayList<Frequencia>();

        // Verifica se esta conectado e da um GET JSON
        if (JsonUtils.estaConectado(this)) {
            new NotasTask().execute(Config.URL_FREQUENCIA_GET);
        } else {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (JsonUtils.estaConectado(getApplicationContext())) {
                            ...
                            new AwesomeErrorDialog(FrequenciaActivity.this)
                                    .setTitle("Erro")
                                    .setMessage("Falha na conexão com a internet.")
                                    .setColoredCircle(R.color.dialogErrorBackgroundColor)
                                    .setDialogIconAndColor(R.drawable.ic_dialog_error, R.color.white)
    ...
    public void limpa() {
        int tamanho = this.frequenciaList.size();
        frequenciaAdapter.posicaoAtual = -1;
        if (tamanho > 0) {
            for (int i = 0; i < tamanho; i++) {
                this.frequenciaList.remove(0);
            }
            frequenciaAdapter.notifyItemRangeRemoved(0, tamanho);
        }
    }
    ...
    public class NotasTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(FrequenciaActivity.this);
        ...
        protected void onPostExecute(String resultado) {
            ...
            if (null == resultado || resultado.length() == 0) {
                ...
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("Frequencia");
                    JSONObject objJson = null;
                    for (int i = 0; i < jsonArray.length(); i++) {
                        objJson = jsonArray.getJSONObject(i);

                        Frequencia frequencia = new Frequencia();
                        frequencia.setIdFrequencia(objJson.getString("idfrequencia"));
                        frequencia.setDisciplina(objJson.getString("disciplina"));
                        frequencia.setData1(objJson.getString("data1"));
                        frequencia.setData2(objJson.getString("data2"));
                        frequencia.setData3(objJson.getString("data3"));
                        frequencia.setQuantidade1(objJson.getString("quantidade1"));
                        frequencia.setQuantidade2(objJson.getString("quantidade2"));
                        frequencia.setQuantidade3(objJson.getString("quantidade3"));

                        frequenciaList.add(frequencia);
                    }
                    frequenciaAdapter = new FrequenciaAdapter(frequenciaList, FrequenciaActivity.this);
                    recyclerView.setAdapter(frequenciaAdapter);
